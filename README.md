...
|[Animal-Identification-from-Video](https://github.com/LucyKuncheva/Animal-Identification-from-Video) ![idfromvideo](./idfromvideo.png)|26 pigs, 9 koi fish, 58 pigeons|2379 frames| pigs (above/side view), koi fish (bird-view) and pigeons on the ground (sideview) in unconstrained poses|BB + identity annotaions|pixabay license|
